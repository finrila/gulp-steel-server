...
var back_pathnamePrefix = require('./back_pathnamePrefix');
...
module.exports = function(connect, options, middleware) {
    ...
    if (options.back_pathnamePrefix) {
        middleware.unshift(back_pathnamePrefix(connect, options));
    }
    ...
    middleware.unshift(function(req, res, next) {
        ...
        if (options.front_hostname.split(/ +/).indexOf(host) > -1) {
